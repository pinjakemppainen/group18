...
public:
    ...
    void setupUi(QDialog *engine)
    {
        ...
        widget = new QWidget(engine);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(30, 70, 239, 86));
        ...
        widget1 = new QWidget(engine);
        widget1->setObjectName(QString::fromUtf8("widget1"));
        widget1->setGeometry(QRect(70, 210, 158, 26));
    ...
    void retranslateUi(QDialog *engine)
    {
        ...
        pushButton_11->setText(QCoreApplication::translate("engine", "clear", nullptr));
